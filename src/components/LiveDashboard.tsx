      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-gradient-to-r from-slate-900 via-blue-950/40 to-slate-900 border border-slate-800 rounded-2xl shadow-sm">
        <div>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white mt-1">
            {t(activeLang, 'dailyTaskStats')} ({currentWebsite})
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
            {t(activeLang, 'realtimeDailyData')} {currentWebsite}
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>{t(activeLang, 'register')}</span>
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl relative overflow-hidden group hover:border-slate-700 transition">
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-slate-400 ml-2">{t(activeLang, 'peopleUnit')}</span>
          </div>
          <p className="text-xs text-slate-500 mt-2 flex items-center gap-1">
            <TrendingUp className="w-3.5 h-3.5 text-blue-400" />
            <span>{t(activeLang, 'inquiriesCount')}</span>
          </p>
        </div>
        ...
        <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl relative overflow-hidden group hover:border-slate-700 transition">
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-slate-400 ml-2">{t(activeLang, 'customersUnit')}</span>
          </div>
          <p className="text-xs text-emerald-400 mt-2 flex items-center gap-1">
            <ArrowUpRight className="w-3.5 h-3.5" />
            <span>{t(activeLang, 'registeredSuccess')}</span>
          </p>
        </div>
        ...
        <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl relative overflow-hidden group hover:border-slate-700 transition">
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-slate-400 ml-2">{t(activeLang, 'transactionsUnit')}</span>
          </div>
          <p className="text-xs text-slate-500 mt-2">
            {t(activeLang, 'depositsToday')}
          </p>
        </div>
        ...
        <div className="p-5 bg-gradient-to-br from-slate-900 via-emerald-950/20 to-slate-900 border border-emerald-500/30 rounded-2xl relative overflow-hidden group shadow-lg shadow-emerald-500/5">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider">
              {t(activeLang, 'totalAmountDollar')}
            </span>
          ...
          <p className="text-xs text-emerald-300/80 mt-2 font-medium">
            {t(activeLang, 'todayDeclaredTotal')} ({currentWebsite})
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-base font-bold text-white flex items-center gap-2">
            ...
            <span>{t(activeLang, 'shiftAnalytics')} ({currentWebsite})</span>
          </h3>
            ...
            <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl relative">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">{t(activeLang, 'shiftMorning')}</h4>
                ...
                <span className="px-2.5 py-1 bg-amber-500/10 text-amber-300 text-xs font-semibold rounded-full border border-amber-500/20">
                  {stats.shiftBreakdown.morningCount} {t(activeLang, 'peopleUnit')}
                </span>
              </div>

              <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between">
                <span className="text-xs text-slate-400">{t(activeLang, 'totalAmount')}</span>
            ...
            <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl relative">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">{t(activeLang, 'shiftNight')}</h4>
                ...
                <span className="px-2.5 py-1 bg-indigo-500/10 text-indigo-300 text-xs font-semibold rounded-full border border-indigo-500/20">
                  {stats.shiftBreakdown.nightCount} {t(activeLang, 'peopleUnit')}
                </span>
              </div>
        ...
        <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl space-y-4">
          <h3 className="text-base font-bold text-white flex items-center gap-2">
            ...
            <span>{t(activeLang, 'platformShare')}</span>
          </h3>

          <div className="space-y-3">
            {Object.keys(stats.platformBreakdown).length === 0 ? (
              <p className="text-xs text-slate-400 py-6 text-center">{t(activeLang, 'noDataToday')}</p>
            ) : (
                  ...
                  <div key={platform} className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="text-slate-400 font-mono">
                        {pData.count} {t(activeLang, 'peopleUnit')} • ${pData.amount.toLocaleString()}
                      </span>
                    </div>
