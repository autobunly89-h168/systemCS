          ...
          <>
            ...
            <div className="p-4 bg-slate-800/40 border-b border-slate-800 text-xs text-slate-300 space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-slate-300 pl-1">
                ...
                <li>លុបកូដចាស់ចោល រួច paste កូដខាងក្រោមនេះចូលទៅក្នុងដိုင်រ៉ិចធូរី <strong>Code.gs</strong></li>
                ...
                <li>ចុច <strong>Deploy</strong> រួច copy យក Web App URL មកប្រើប្រាស់ជាការស្រេច!</li>
              </ol>
            </div>
